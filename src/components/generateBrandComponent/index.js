  ...
  return (
    <div className="generate-brand-wrapper">
      ...
      <div className='brand-selected-chip-Wrapper'> 
        <div className='brand-selected-chip-heading'>Total {selectedChips.length} attributes selected </div>
      ...
      <CustomCollapseCard
        title="Define Criteria for name generation."
      >
       <div className='brand-counter'>
       <IncrementDecrementCounter label ={'Minimum lenght'} counts ={minLength} getCount = {getMinCount} />
       <IncrementDecrementCounter label ={'Maximum lenght'} counts ={maxLength} getCount = {getMaxCount} />
        </div> 
        <div className='brand-counter'>
       <IncrementDecrementCounter label ={'Minimum syllable count'} counts ={minSyllableCount} getCount = {getMinSyllableCount} />
       <IncrementDecrementCounter label ={'Maximum syllable count'} counts ={maxSyllableCount} getCount = {getMaxSyllableCount} />
        </div> 
